...
class Board:
    ...
    def make_new_board(self):
        ...
        while bombs_planted < self.num_bombs:
            loc = random.randint(0, self.dim_size*self.dim_size - 1) # return a random integer N such that a <= N <= b
    ...
    def get_visible_board(self):
        #similar to __str__ method, but returns list instead of string
