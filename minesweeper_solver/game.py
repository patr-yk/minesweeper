...
def play(dim_size=10, num_bombs=10, auto_solving=True):
    # Step 1: create the board and plant the bombs
    board = Board(dim_size,  num_bombs)
    minesweeper = MinesweeperSolver(board)

    # Step 2: show the board and ask MinesweeperSolver for field to dig
    ...
    #for x in range(5):
        ...
        if not auto_solving:
            ...
            #user input was replaced with step method of MinesweeperSolver
